...
public class InfestedMushroomBlockEntityWalksOnTheBlockProcedure extends CavesAndCliffsUpdateAddonModElements.ModElement {
	public InfestedMushroomBlockEntityWalksOnTheBlockProcedure(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 174);
	}
		...
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CavesAndCliffsUpdateAddonMod.LOGGER
						.warn("Failed to load dependency entity for procedure InfestedMushroomBlockEntityWalksOnTheBlock!");
			return;
		}
