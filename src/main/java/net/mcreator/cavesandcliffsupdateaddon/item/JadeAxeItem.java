...
public class JadeAxeItem extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:jade_axe")
	public static final Item block = null;
	public JadeAxeItem(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 130);
	}
