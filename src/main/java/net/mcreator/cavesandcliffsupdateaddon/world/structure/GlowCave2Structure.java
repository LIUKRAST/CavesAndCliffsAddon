...
public class GlowCave2Structure extends CavesAndCliffsUpdateAddonModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public GlowCave2Structure(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 228);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("glow_cave_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("caves_and_cliffs_update_addon:glow_cave_2"),
					configuredFeature);
		}
	}
	@SubscribeEvent
