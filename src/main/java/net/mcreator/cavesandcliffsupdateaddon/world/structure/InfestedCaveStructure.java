...
public class InfestedCaveStructure extends CavesAndCliffsUpdateAddonModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public InfestedCaveStructure(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 215);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 100000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("caves_and_cliffs_update_addon", "infested_cave"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("infested_cave"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("caves_and_cliffs_update_addon:infested_cave"),
					configuredFeature);
		}
	}
	@SubscribeEvent
