...
public class EpidoteBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:epidote")
	public static final Block block = null;
	public EpidoteBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 9);
	}
