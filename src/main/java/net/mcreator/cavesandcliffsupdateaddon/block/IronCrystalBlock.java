...
public class IronCrystalBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:iron_crystal")
	public static final Block block = null;
	public IronCrystalBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 44);
	}
