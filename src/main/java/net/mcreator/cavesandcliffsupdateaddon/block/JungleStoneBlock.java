...
public class JungleStoneBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:jungle_stone")
	public static final Block block = null;
	public JungleStoneBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 11);
	}
