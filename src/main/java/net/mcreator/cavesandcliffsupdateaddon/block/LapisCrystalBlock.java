...
public class LapisCrystalBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:lapis_crystal")
	public static final Block block = null;
	public LapisCrystalBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 15);
	}
