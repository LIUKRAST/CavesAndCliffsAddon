...
public class CoalCrystalBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:coal_crystal")
	public static final Block block = null;
	public CoalCrystalBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 14);
	}
