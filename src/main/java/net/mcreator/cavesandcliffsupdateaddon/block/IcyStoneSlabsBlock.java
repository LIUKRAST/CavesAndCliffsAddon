...
public class IcyStoneSlabsBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:icy_stone_slabs")
	public static final Block block = null;
	public IcyStoneSlabsBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 63);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("icy_stone_slabs");
		}
