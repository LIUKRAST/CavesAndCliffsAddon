...
public class IcyStoneBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:icy_stone")
	public static final Block block = null;
	public IcyStoneBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 62);
	}
