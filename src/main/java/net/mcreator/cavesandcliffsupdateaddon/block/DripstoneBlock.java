...
import net.mcreator.cavesandcliffsupdateaddon.procedures.DripstoneBlockAddedProcedure;
...
public class DripstoneBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:dripstone")
	public static final Block block = null;
	public DripstoneBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 202);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int z = pos.getZ();
			{
				...
				DripstoneBlockAddedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
