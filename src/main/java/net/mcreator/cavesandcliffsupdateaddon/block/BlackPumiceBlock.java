...
public class BlackPumiceBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:black_pumice")
	public static final Block block = null;
	public BlackPumiceBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 86);
	}
