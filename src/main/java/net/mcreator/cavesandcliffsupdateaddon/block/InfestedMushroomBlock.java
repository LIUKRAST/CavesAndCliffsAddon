...
public class InfestedMushroomBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:infested_mushroom")
	public static final Block block = null;
	public InfestedMushroomBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 169);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("infested_mushroom");
		}
