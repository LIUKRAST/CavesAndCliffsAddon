...
public class WhitePumiceBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:white_pumice")
	public static final Block block = null;
	public WhitePumiceBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 87);
	}
