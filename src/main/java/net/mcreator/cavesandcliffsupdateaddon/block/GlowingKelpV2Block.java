...
public class GlowingKelpV2Block extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:glowing_kelp_v_2")
	public static final Block block = null;
	public GlowingKelpV2Block(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("glowing_kelp_v_2");
		}
