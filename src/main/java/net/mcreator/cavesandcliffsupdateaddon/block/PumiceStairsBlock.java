...
public class PumiceStairsBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:pumice_stairs")
	public static final Block block = null;
	public PumiceStairsBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 101);
	}
