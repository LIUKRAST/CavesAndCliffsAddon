...
public class GlowingVineEndBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:glowing_vine_end")
	public static final Block block = null;
	public GlowingVineEndBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("glowing_vine_end");
		}
