...
public class CopperCrystalBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:copper_crystal")
	public static final Block block = null;
	public CopperCrystalBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 19);
	}
