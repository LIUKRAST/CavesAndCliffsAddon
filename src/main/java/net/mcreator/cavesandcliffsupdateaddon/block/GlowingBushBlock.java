...
public class GlowingBushBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:glowing_bush")
	public static final Block block = null;
	public GlowingBushBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 58);
	}
