...
public class EmeraldCrystalBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:emerald_crystal")
	public static final Block block = null;
	public EmeraldCrystalBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 20);
	}
