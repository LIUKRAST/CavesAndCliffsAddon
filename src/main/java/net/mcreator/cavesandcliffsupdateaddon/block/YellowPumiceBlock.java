...
public class YellowPumiceBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:yellow_pumice")
	public static final Block block = null;
	public YellowPumiceBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 88);
	}
