...
public class GlowingVineBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:glowing_vine")
	public static final Block block = null;
	public GlowingVineBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 27);
	}
