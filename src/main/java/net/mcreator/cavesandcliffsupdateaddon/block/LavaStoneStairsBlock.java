...
public class LavaStoneStairsBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:lava_stone_stairs")
	public static final Block block = null;
	public LavaStoneStairsBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 98);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("lava_stone_stairs");
		}
