...
public class BrownPumiceBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:brown_pumice")
	public static final Block block = null;
	public BrownPumiceBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 89);
	}
