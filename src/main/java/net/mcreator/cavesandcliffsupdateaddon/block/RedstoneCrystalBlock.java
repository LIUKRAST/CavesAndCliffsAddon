...
public class RedstoneCrystalBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:redstone_crystal")
	public static final Block block = null;
	public RedstoneCrystalBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 34);
	}
