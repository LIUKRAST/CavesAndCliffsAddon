...
public class LavaStone1Block extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:lava_stone_1")
	public static final Block block = null;
	public LavaStone1Block(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 95);
	}
