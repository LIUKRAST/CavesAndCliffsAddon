...
import net.mcreator.cavesandcliffsupdateaddon.procedures.MoltenHiveUpdateTickProcedure;
...
public class MoltenHiveBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:molten_hive")
	public static final Block block = null;
	public MoltenHiveBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 110);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				MoltenHiveUpdateTickProcedure.executeProcedure($_dependencies);
			}
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
		}
	}
