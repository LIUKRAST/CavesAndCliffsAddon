...
public class GlowBlossomBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:glow_blossom")
	public static final Block block = null;
	public GlowBlossomBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 31);
	}
