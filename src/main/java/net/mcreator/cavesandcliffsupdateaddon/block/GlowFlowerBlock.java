...
public class GlowFlowerBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:glow_flower")
	public static final Block block = null;
	public GlowFlowerBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 32);
	}
