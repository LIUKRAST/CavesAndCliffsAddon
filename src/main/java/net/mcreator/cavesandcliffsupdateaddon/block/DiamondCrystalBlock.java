...
public class DiamondCrystalBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:diamond_crystal")
	public static final Block block = null;
	public DiamondCrystalBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 13);
	}
