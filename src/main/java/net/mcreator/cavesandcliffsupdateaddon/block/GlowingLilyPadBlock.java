...
public class GlowingLilyPadBlock extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:glowing_lily_pad")
	public static final Block block = null;
	public GlowingLilyPadBlock(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("glowing_lily_pad");
		}
