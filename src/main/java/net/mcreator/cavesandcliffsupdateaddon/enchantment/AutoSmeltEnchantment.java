...
public class AutoSmeltEnchantment extends CavesAndCliffsUpdateAddonModElements.ModElement {
	@ObjectHolder("caves_and_cliffs_update_addon:auto_smelt")
	public static final Enchantment enchantment = null;
	public AutoSmeltEnchantment(CavesAndCliffsUpdateAddonModElements instance) {
		super(instance, 196);
	}
